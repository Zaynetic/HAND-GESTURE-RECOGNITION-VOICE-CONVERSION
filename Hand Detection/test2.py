...
def process_hand_gesture(frame, results):
    ...
    if not welcome_message_spoken:
        ...
        welcome_message = "Welcome to Hand gesture recognition and voice conversion the project of signal and systems developed by Zain, zaghum & waqar."
        cv2.putText(frame, welcome_message, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
        threading.Thread(target=speak_out, args=(welcome_message,)).start()
